        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "20px", marginBottom: "20px", marginTop: "15px" }}>
              ...
              <Space direction="vertical">
                ...
                {rangeMode === RangeMode.CUSTOM ? (
                  ...
                  <SettingsContainer indentPx={28}>
                    <SettingsItem label={<span>Range:</span>}>
                      <HorizontalDiv>
                        <InputNumber
                          style={{ width: 60 }}
                    ...
                    <SettingsItem label={<span>Frame increment:</span>}>
                      <FlexRow $gap={6}>
                        <SpinBox
          ...
          {recordingMode === RecordingMode.VIDEO_MP4 && (
            <Card size="small" title={<p>Video settings</p>}>
              <SettingsContainer>
                <SettingsItem label={<span>Frames per second:</span>}>
                  <FlexRow $gap={6}>
                ...
                <SettingsItem label={<span>Video quality:</span>}>
                  <FlexRow $gap={6}>
