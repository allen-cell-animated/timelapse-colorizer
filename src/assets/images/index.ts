...
import AimIconSVGAsset from "./icon-aim.svg?react";
import AimSlashIconSVGAsset from "./icon-aim-slash.svg?react";
...
export const AimIconSVG = AimIconSVGAsset;
export const AimSlashIconSVG = AimSlashIconSVGAsset;
