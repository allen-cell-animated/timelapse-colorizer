...
import ContourIconSVGAsset from "./icon-contour.svg?react";
import ContourSlashIconSVGAsset from "./icon-contour-slash.svg?react";
...
import LinePlotIconSVGAsset from "./icon-line-plot.svg?react";
import LinePlotSlashIconSVGAsset from "./icon-line-plot-slash.svg?react";
...
export const ContourSlashIconSVG = ContourSlashIconSVGAsset;
export const ImagesIconSVG = ImagesIconSVGAsset;
export const ImagesSlashIconSVG = ImagesSlashIconSVGAsset;
export const LinePlotIconSVG = LinePlotIconSVGAsset;
export const LinePlotSlashIconSVG = LinePlotSlashIconSVGAsset;
