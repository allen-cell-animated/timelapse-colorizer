 ...
 *   - An array of array of keycode strings, representing multiple possible
 *     keycode aliases for the same action. Each child array will be treated as
 *     a combination of keys, as above. ex: [["ArrowLeft"], ["Shift", "L"]] will
...
export const getShortcutDisplayText = (keycode: NestedValuesOfExcludeArrays<typeof ShortcutKeycode>): string => {
  if (Array.isArray(keycode)) {
    ...
    if (Array.isArray(firstCode)) {
      // An array of multiple keycode aliases. Return just the first one.
