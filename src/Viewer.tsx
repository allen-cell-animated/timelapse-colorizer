...
import { isUrl, makeGitHubIssueLink, UrlParam } from "./colorizer/utils/url_utils";
...
import { DEFAULT_PLAYBACK_FPS, INTERNAL_BUILD, VERSION_NUMBER } from "./constants";
    ...
    const loadInitialDataset = async (): Promise<void> => {
      ...
      try {
        ...
        const githubIssueLink = makeGitHubIssueLink(
          "Viewer settings could not be loaded from the URL: `" + (error as Error).message.slice(0, 100) + "`",
          "*[This issue was auto-generated by TFE]*" +
            "\n\nInitial loading of viewer settings from the URL failed unexpectedly." +
            "\n\n**URL:**\n```\n" +
