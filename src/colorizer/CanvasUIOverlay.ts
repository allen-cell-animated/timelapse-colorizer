...
const defaultBackgroundOptions: OverlayBackgroundOptions = {
...
export default class CanvasOverlay {
  ...
  private backgroundOptions: OverlayBackgroundOptions;

  constructor(
    scaleBarOptions: ScaleBarOptions = defaultScaleBarOptions,
    timestampOptions: TimestampOptions = defaultTimestampOptions,
    overlayOptions: OverlayBackgroundOptions = defaultBackgroundOptions
  ) {
  ...
  updateBackgroundOptions(options: Partial<OverlayBackgroundOptions>): void {
