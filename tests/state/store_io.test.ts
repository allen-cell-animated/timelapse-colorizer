...
const EXAMPLE_STORE_EXPECTED_QUERY_STRING =
  ...
  "&path=1&path-color=ff0000&path-width=1.500&path-mode=1&path-breaks=1&path-steps=10%2C25%21&path-persist=0&scalebar=1&timestamp=0&filter-color=ff0000&filter-mode=0&outlier-color=00ff00&outlier-mode=1&outline-color=0000ff" +
