...
const EXAMPLE_STORE: ViewerStoreSerializableState = {
  ...
  scatterContourColorRampKey: COLOR_RAMP_KEY,
  scatterContourColorRampReversed: true,
  channelSettings: [
...
const EXAMPLE_STORE_EXPECTED_PARAMS: ExpectedParamType = {
  ...
  "scatter-cont": "1",
  "scatter-cont-num": "25",
  "scatter-cont-color": COLOR_RAMP_KEY + "!",
...
const EXAMPLE_STORE_EXPECTED_QUERY_STRING =
  ...
  "&tab=filters&interpolate=1&scatter-x=feature3&scatter-y=feature2&scatter-hist=1&scatter-bins=150&scatter-range=all&scatter-cont=1&scatter-cont-num=25&scatter-cont-color=matplotlib-inferno%21" +
