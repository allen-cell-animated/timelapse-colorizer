...
const EXAMPLE_STORE: ViewerStoreSerializableState = {
  ...
  scatterAverageLineWidth: 4.5,
  scatterAverageLineWindow: 11,
...
const EXAMPLE_STORE_EXPECTED_QUERY_STRING =
  ...
  "&tab=filters&plot=3d_plot&interpolate=1&scatter-x=feature3&scatter-y=feature2&sc-hist=1&scatter-bins=150&scatter-range=all&sc-cont=1&sc-cont-num=25&sc-avg=0&sc-avg-n=11&sc-avg-w=4.5" +
