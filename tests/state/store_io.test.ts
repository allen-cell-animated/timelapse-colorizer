...
const EXAMPLE_STORE_EXPECTED_QUERY_STRING =
  ...
  "&tab=filters&interpolate=1&scatter-x=feature3&scatter-y=feature2&scatter-hist=1&scatter-bins=150&scatter-range=all&scatter-heatmap=1&heatmap-color=matplotlib-inferno" +
