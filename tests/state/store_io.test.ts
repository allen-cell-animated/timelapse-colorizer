...
const EXAMPLE_STORE_EXPECTED_QUERY_STRING =
  ...
  "&tab=filters&interpolate=1&scatter-x=feature3&scatter-y=feature2&sc-sync-x=0&sc-sync-y=1&sc-hist=1&scatter-bins=150&scatter-range=all&sc-cont=1&sc-cont-num=25&sc-avg=0&sc-avg-n=11&sc-avg-w=4.5" +
